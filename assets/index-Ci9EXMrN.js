import{p as f,r as i,R as h,o,b as r,d as e,h as c,t as m,g as _,F as g,D as t}from"./index-Cy5EtEjA.js";const b={class:"flex justify-between"},k={class:"flex"},x={class:"mt-4"},V=e("div",{class:"italic text-sm font-semibold leading-6 mr-8",style:{width:"500px"}},[e("p",null,[e("span",{class:"text-xl"},"注："),t(" vue3 中，对象、数组的更新不再需要 $set（且已被 "),e("a",{class:"text-blue-600",href:"https://v3-migration.vuejs.org/zh/breaking-changes/#被移除的-api"},"移除"),t(" ），只需要用 ref、reactive 声明对象、数组即可实现实时响应，如 const obj = reactive({ a: 1 })，你可以直接使用 obj.b = 2，即可更新数据，并实时响应。这与 vue3 的 proxy 实现原理有关。 ")])],-1),w={class:"mt-8",style:{width:"600px"}},y=e("p",{class:"font-bold"},"组件代码：",-1),j=e("pre",null,[t("        "),e("code",null,[t(`
<template>
